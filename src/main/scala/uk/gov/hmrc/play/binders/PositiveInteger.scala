...
object PositiveInteger {
  ...
  implicit def stringToPositiveInteger(implicit stringBinder: QueryStringBindable[Int]) : QueryStringBindable[PositiveInteger] = new QueryStringBindable[PositiveInteger] {
